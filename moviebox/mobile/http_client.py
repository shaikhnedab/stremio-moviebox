...
from moviebox.mobile.crypto import build_signed_headers
from moviebox.mobile.helpers import (
    combine_url_path_with_params,
    process_api_response,
)
from moviebox.mobile.logger import logger
from moviebox.mobile.urls import DEFAULT_API_BASE, HOST_POOL, MAIN_PAGE_PATH


class ProviderHttpClient:
    """
    Async HTTP client for the Provider API with:
    ...
    * Transparent bearer-token refresh from ``x-user`` response headers.
    ...
    async def start(self) -> ProviderHttpClient:
