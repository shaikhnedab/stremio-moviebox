...
DEFAULT_REQUEST_HEADERS = {'X-Client-Info': '{"timezone":"Africa/Nairobi"}', 'Accept-Language': 'en-US,en;q=0.5', 'Accept': 'application/json', 'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36(KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36 Firefox/137.0', 'Referer': HOST_URL, 'Host': SELECTED_HOST}
'For general http requests other than download'
DOWNLOAD_REQUEST_REFERER = 'https://fmoviesunblocked.net/'
DOWNLOAD_REQUEST_HEADERS = {'Accept': '*/*', 'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64; rv:137.0) Gecko/20100101 Firefox/137.0', 'Origin': SELECTED_HOST, 'Referer': DOWNLOAD_REQUEST_REFERER}
'For media and subtitle files download requests'
type DownloadQualitiesType = t.Literal['WORST', 'BEST', '360P', '480P', '720P', '1080P']
