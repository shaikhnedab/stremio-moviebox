...
from moviebox.legacy._bases import BaseContentProvider
from moviebox.legacy.helpers import (
    assert_instance,
    get_absolute_url,
)
from moviebox.legacy.models import SearchResultsItem, StreamFilesMetadata
from moviebox.legacy.requests import Session


class StreamFilesDetail(BaseContentProvider):
    # https://provider.ng/wefeed-h5-bff/web/subject/play?subjectId=4006958073083480920&se=1&ep=1
